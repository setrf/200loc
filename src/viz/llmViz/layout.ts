...
const baseNodes: VizLayoutNode[] = [
  ...
  {
    id: 'token-embedding',
    label: 'Meaning Lookup',
    subtitle: 'token table row',
    x: -220,
    y: 220,
    z: 0,
    width: 190,
  ...
  {
    id: 'norm-1',
    label: 'Scale Cleanup 1',
    subtitle: 'rescale the state',
    x: -86,
    y: 464,
    z: 0,
    width: 172,
  ...
  {
    id: 'norm-2',
    label: 'Scale Cleanup 2',
    subtitle: 'rescale again',
    x: -86,
    y: 1130,
    z: 0,
    width: 172,
  ...
  {
    id: 'logits',
    label: 'Next-Token Scores',
    subtitle: 'raw preferences',
    x: -126,
    y: 1434,
    z: 0,
    width: 252,
