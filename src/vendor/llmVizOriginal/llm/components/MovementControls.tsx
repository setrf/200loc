import { faArrowDown, faArrowLeft, faArrowRight, faArrowUp, faCircleDot, faExpand, faMagnifyingGlassMinus, faMagnifyingGlassPlus } from "@fortawesome/free-solid-svg-icons";
import type { IconDefinition } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import clsx from "clsx";
import React, { useState } from "react";
import type { ICameraPos } from "../Camera";
import { getBlkDimensions } from "../GptModelLayout";
import type { IBlkDef, IBlkLabel, IGptLayerNormLayout, IGptModelLayout } from "../GptModelLayout";
import type { IProgramState } from "../Program";
import type { IRenderView } from "../render/modelRender";
import { useProgramState } from "../Sidebar";
import { clamp, isNotNil } from "@llmviz/utils/data";
import { lerp } from "@llmviz/utils/math";
import { useTouchEvents } from "@llmviz/utils/pointer";
import { BoundingBox3d, Vec3 } from "@llmviz/utils/vector";
