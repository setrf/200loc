import { base64ToArrayBuffer } from "@llmviz/utils/data";
import { Mat4f } from "@llmviz/utils/matrix";
import { bindFloatAttribs, createFloatBuffer, createShaderProgram, ensureFloatBufferSize, ensureShadersReady, resetFloatBufferMap, uploadFloatBuffer } from "@llmviz/utils/shader";
import type { IFloatBuffer, IGLContext } from "@llmviz/utils/shader";
import { Vec4 } from "@llmviz/utils/vector";
import { modelViewUboText, RenderPhase, UboBindings } from "./sharedRender";
import type { ISharedRender } from "./sharedRender";
