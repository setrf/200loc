import type { IAddLayerLink, IAttentionLayerLink, IBlockLayerLink, IEmbedLayerLink, IGptModelLink, ILayerNormLayerLink, ILinearLayerLink, IMlpLayerLink, IModelShape, ISoftmaxLayerLink } from "./GptModel";
import { NativeFunctions, TensorType } from "./NativeBindings";
import { makeArray } from "@llmviz/utils/data";
import { createBufferTex as createBufferTex2, writeToBufferTex } from "@llmviz/utils/renderPhases";
import type { IBufferTex } from "@llmviz/utils/renderPhases";
